...
latest_version = max(os.listdir(BASE_DIR))  # gets 1731484161

MODEL_PATH = os.path.join(BASE_DIR, latest_version, "model.pkl")
PREPROCESSING_PATH = os.path.join(BASE_DIR, latest_version, "preprocessing.pkl")
